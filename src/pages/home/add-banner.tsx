...
import { createBanners } from "Redux/Action/Home/home.action";
...
const Banner: NextPage = () => {
    ...
    const { message, loading, success } = useAppSelector(state => state.createBanner);
    //State
    ...
    const onSubmit: SubmitHandler<Inputs> = (data, e) => {
        if (images.length === 0) {
            ...
            dispatch(createBanners(data, images[0]?.file as File))
        }
    }
