...
import { createSliders } from "Redux/Action/Home/home.action";
...
const AddSlider = () => {
    ...
    const { message, loading, success } = useAppSelector(state => state.createSlider);
    //State
    ...
    const onSubmit: SubmitHandler<Inputs> = (data, e) => {
        if (images.length === 0) {
            ...
            dispatch(createSliders(data, images[0]?.file as File))
        }
    }
