                        ...
                        >
                            {({
                                ...
                                <Box>
                                    ...
                                    {imageList.length === 0 && product?.productImages &&
                                        <Box>
                                            <Grid container spacing={3}>
                                                {product.productImages.map((item: any, i: number) => (
                                                    <Grid item {...{ md: 3 }} key={i}>
                                                        <Box sx={styles.PreviewImage}>
                                                            <Image src={process.env.NEXT_PUBLIC_IMAGE_PATH + item?.url} alt="Image" width={120} height={100} />
                                                        </Box>
                                                    </Grid>
                                                ))}
                                            </Grid>
